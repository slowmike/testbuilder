...
describe('should support China UnionPay', function() {
  ...
  for(i = 126; i <= 925; i++ ) {
    (function(i) {
      it('has a prefix of 622'+i+' and a length of 16', function() {
          detectNetwork("622"+i.toString()+"7890123456").should.equal('China UnionPay');
      });
      it('has a prefix of 622'+i+' and a length of 17', function() {
          detectNetwork("622"+i.toString()+"78901234567").should.equal('China UnionPay');
      });
      it('has a prefix of 622'+i+' and a length of 18', function() {
          detectNetwork("622"+i.toString()+"789012345678").should.equal('China UnionPay');
      });
      it('has a prefix of 622'+i+' and a length of 19', function() {
          detectNetwork("622"+i.toString()+"7890123456789").should.equal('China UnionPay');
      });
    })(i);
  }
  //prefix 624-626
  for(var i = 4; i <=6; i++ ) {
    (function(i) {
      it('has a prefix of 62'+i+' and a length of 16', function() {
          detectNetwork("62"+i.toString()+"4567890123456").should.equal('China UnionPay');
      });
      it('has a prefix of 62'+i+' and a length of 17', function() {
          detectNetwork("62"+i.toString()+"45678901234567").should.equal('China UnionPay');
      });
      it('has a prefix of 62'+i+' and a length of 18', function() {
          detectNetwork("62"+i.toString()+"456789012345678").should.equal('China UnionPay');
      });
      it('has a prefix of 62'+i.toString()+' and a length of 19', function() {
          detectNetwork("62"+i.toString()+"4567890123456789").should.equal('China UnionPay');
      });
    })(i);
  }
  //prefix 6282-6288
  for(var i = 2; i <=8; i++ ) {
    (function(i) {
      it('has a prefix of 628'+i+' and a length of 16', function() {
          detectNetwork("628"+i.toString()+"567890123456").should.equal('China UnionPay');
      });
      it('has a prefix of 628'+i+' and a length of 17', function() {
          detectNetwork("628"+i.toString()+"5678901234567").should.equal('China UnionPay');
      });
      it('has a prefix of 628'+i+' and a length of 18', function() {
          detectNetwork("628"+i.toString()+"56789012345678").should.equal('China UnionPay');
      });
      it('has a prefix of 628'+i+' and a length of 19', function() {
          detectNetwork("628"+i.toString()+"567890123456789").should.equal('China UnionPay');
      });
    })(i);
  }
});
describe('should support Switch', function() {
  ...
  for(i = 0; i < switchPrefixes.length; i++) {
    (function (switchPrefix) {
      it('has a prefix of '+switchPrefix+' and a length of 16', function() {
          detectNetwork(switchPrefix+"1234567890123456".substring(switchPrefix.length)).should.equal('Switch');
      });
      it('has a prefix of '+switchPrefix+' and a length of 18', function() {
          detectNetwork(switchPrefix+"123456789012345678".substring(switchPrefix.length)).should.equal('Switch');
      });
      it('has a prefix of '+switchPrefix+' and a length of 19', function() {
          detectNetwork(switchPrefix+"1234567890123456789".substring(switchPrefix.length)).should.equal('Switch');
      });
    })(switchPrefixes[i]);
  }
});
